...
public class task4 {
    ...
    public static void toStarShorthand(String word){
        ...
        for(int i=0;i<words.length-1;i++){
            ...
            if((words[i]!=words[i+1] ) && iteration>1){
                if(i==words.length-2){
                    temp+=words[i];
                }
                temp+="*"+iteration;
    ...
    public static boolean doesRhyme(String w1, String w2){
        ...
        for(int i=0;i<ar.length;i++){
            if(ar[i]=='a' || ar[i]=='o' || ar[i]=='e' || ar[i]=='i' || ar[i]=='u'|| ar[i]=='y'){
                temp+=ar[i];
            }
        }
        for(int i=0;i<ar2.length;i++){
            if(ar2[i]=='a' || ar2[i]=='o' || ar2[i]=='e' || ar2[i]=='i' || ar2[i]=='u' ||ar[i]=='y'){
                temp2+=ar2[i];
            }
        }
